...
import com.xkcoding.helloworld.proxy.service.proxy.SubServiceProxy;
import com.xkcoding.helloworld.proxy.service.proxy.SubServiceProxyFactory;
...
public class ServiceBeanDefinitionRegistry implements BeanDefinitionRegistryPostProcessor,ResourceLoaderAware,ApplicationContextAware {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for (Class beanClazz : beanProxyClazzs) {
            ...
            definition.setBeanClass(SubServiceProxyFactory.class);
            //这里采用的是byType方式注入，类似的还有byName等
            definition.setAutowireMode(GenericBeanDefinition.AUTOWIRE_BY_TYPE);
            // 重新注入代理对象
...
//        PeterService peterBean = applicationContext.getBean(PeterService.class);
//        System.out.println("...");
//        System.out.println(peterBean);
//        System.out.println(peterBean.getClass());
//        BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(peterBean.getClass());
//        GenericBeanDefinition definition = (GenericBeanDefinition) builder.getRawBeanDefinition();
//        definition.getConstructorArgumentValues().addGenericArgumentValue(peterBean);
//        definition.setBeanClass(SubServiceProxyFactory.class);
//        //这里采用的是byType方式注入，类似的还有byName等
//        definition.setAutowireMode(GenericBeanDefinition.AUTOWIRE_BY_TYPE);
//        // 重新注入代理对象
//        String proxyBeanName = toLowerCaseFirstOne(peterBean.getClass().getSimpleName() + "Proxy");
//        System.out.println(proxyBeanName);
//        registry.registerBeanDefinition(proxyBeanName, definition);
